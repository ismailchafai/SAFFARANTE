...
public class Config extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers(HttpMethod.GET, "/api/categoriesAppartemen/").permitAll()

                .antMatchers(HttpMethod.PUT, "/api/appartement/").hasAuthority("MANAGER-APT")
                .antMatchers(HttpMethod.POST, "/api/appartement/").hasAuthority("MANAGER-APT")
                .antMatchers(HttpMethod.DELETE, "/api/appartement/").hasAuthority("MANAGER-APT")
